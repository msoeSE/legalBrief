        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JudgeFirstName = table.Column<string>(nullable: true),
                    JudgeLastName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    AppellateCourtCaseNumber = table.Column<string>(nullable: true),
                    ...
                    CircuitCourtCaseId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Briefs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Briefs_Cases_CircuitCourtCaseId",
                        column: x => x.CircuitCourtCaseId,
                        principalTable: "Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Briefs_Contacts_ContactInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Briefs_ApplicationUserId",
                table: "Briefs",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Briefs_CircuitCourtCaseId",
                table: "Briefs",
                column: "CircuitCourtCaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Briefs_ContactInfoId",
                table: "Briefs",
